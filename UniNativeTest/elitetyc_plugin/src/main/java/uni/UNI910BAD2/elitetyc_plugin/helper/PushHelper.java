package uni.UNI910BAD2.elitetyc_plugin.helper;

import static anet.channel.GlobalAppRuntimeInfo.getUserId;
...
public class PushHelper {
    private static final  String TAG = "UPushModule===>>";
    //private static final String TAG = PushHelper.class.getSimpleName();
    private static Intent Broadcast_Action;
...
/*
    public static Intent registerReceiver(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter, BroadcastReceiver receiver, IntentFilter filter) {
...
/*    @Override
    ...
    public static void init(Context context) {
       ...
       // PushAgent.getInstance(context).onAppStart();
        String packageName="uni.UNI910BAD2";
        //获取消息推送实例
...
// 3：调用sendBroadcast把广播发送出去
       ...
       /* Intent intent = new Intent();
        ...
        //YouMengPushIntentService youMengPushIntentService = new YouMengPushIntentService();
        context.sendBroadcast(intent);//注册广播接收器，接收CONNECTIVITY_CHANGE这个广播*/
